<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="부산">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in busan" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/busan.jpg" alt="busan"  height="350">
          </div>
            <div class="location-description">
              ...
              <p>부산은 대한민국 남동부에 위치한 대도시로 국내외 관광객들이 많이 찾는 대표적인 관광도시 중 하나입니다.
                    대표적인 도시로는 부산진구, 해운대구, 수영구 등이 있으며, 부산항과 부산국제공항 등을 비롯한 교통시설도 잘 발달되어 있습니다.
                    대표적인 관광지로는 해운대해수욕장, 광안리해수욕장, 태종대 등이 있으며, 부산의 대표적인 랜드마크 중 하나인 부산타워에서는 부산의 멋진 야경을 즐길 수 있습니다.
              </p>
            </div>
        </div>
     </div>
...
import busan from './data/busan.js';
