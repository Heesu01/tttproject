<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="경상남도">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in gyeongsangnamdo" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/gyeongnam.jpg" alt="gyeongsangnamdo"  height="350">
          </div>
            <div class="location-description">
              <span>
              <img id="icon" src="../../assets/location_icon.png" alt="Location Icon" style="vertical-align: middle; width: 2rem; height: 2rem;" >
              <span><h2>경상남도</h2></span>
            </span>
              <p>경상남도는 대한민국 남동쪽에 위치한 지방입니다.  경남은 부산과 인접해 있으며, 일대에서 가장 큰 도시인 창원시를 중심으로 다양한 지역들로 이루어져 있습니다.
                    경상남도는 역사와 문화, 자연 경관 등 다양한 측면에서 매력적인 지역입니다. 대표적인 역사문화 관광지로는 경주의 세계문화유산인 불국사, 석굴암 등이 있습니다. 
                    경상남도는 자연 경관도 풍부합니다. 경상남도에는 해상 레저스포츠를 즐길 수 있는 해수욕장도 많이 있습니다. 
              </p>
            </div>
        </div>
     </div>
...
<script>
import gyeongsangnamdo from './data/gyeongsangnamdo.js';
