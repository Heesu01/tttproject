<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="충청북도">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in chungcheongbukdo" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/chungbuk.jpg" alt="chungcheongbukdo"  height="350">
          </div>
            <div class="location-description">
              <span>
              <img id="icon" src="../../assets/location_icon.png" alt="Location Icon" style="vertical-align: middle; width: 2rem; height: 2rem;" >
              <span><h2>충청북도</h2></span>
            </span>
              <p>충청북도는 대한민국 중앙에 위치한 지역으로, 수도인 서울과 대구를 연결하는 교통의 중심지이기도 합니다. 충청북도는 넓은 평야와 숲, 계곡 등이 있는 지형적 특성으로 인해 자연경관이 풍부한 곳으로, 많은 관광객들이 찾는 지역입니다.
                    충청북도의 대표적인 관광지에는 청주, 보은, 제천, 충주 들이 있습니다.
              </p>
            </div>
        </div>
     </div>
...
import chungcheongbukdo from './data/chungcheongbukdo';
