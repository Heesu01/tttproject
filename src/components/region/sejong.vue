<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="세종">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in sejong" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/sejong.jpg" alt="sejong"  height="350">
          </div>
            <div class="location-description">
              ...
              <p>세종시는 대한민국의 중부에 위치한 도시로, 2012년 7월에 서울특별시, 경기도, 충청남도 일부 지역을 분리해 설립되었습니다. 세종시는 대한민국의 행정수도로 지정되어 있으며, 정부부처와 공공기관, 대사관 등이 위치해 있습니다.
                    세종시에는 다양한 관광지가 위치해 있습니다. 대표적인 관광지로는 한국민속촌, 호수공원, 한빛탑, 조계사 등이 있습니다. 또한, 세종시에는 한글박물관, 훈련원공원, 백파재 등의 관광지도 있습니다.
              </p>
            </div>
        </div>
     </div>
...
<script>
import sejong from './data/sejong.js';
