<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="강원">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in gangwondo" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/gangwon.jpg" alt="gangwondo"  height="350">
          </div>
            <div class="location-description">
              ...
              <p>강원도에는 여러 도시와 관광지가 있습니다. 대표적인 도시로는 강릉시, 속초시, 원주시, 춘천시 등이 있으며, 관광지로는 설악산, 오대산, 속초 해수욕장, 남이섬, 정동진 등이 있습니다. 
                        또한, 동해안을 따라 맛집과 볼거리가 많은 도시인 강릉시에서는 매년 동계올림픽과 강원랜드를 비롯한 다양한 축제와 이벤트가 열립니다.
                        이처럼 강원도는 자연과 문화, 역사가 공존하는 지역으로, 산과 바다, 도시와 자연이 공존하는 다양한 매력을 지니고 있습니다.
              </p>
            </div>
        </div>
     </div>
...
<script>
import gangwondo from './data/gangwondo.js';
