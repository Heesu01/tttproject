<template>
    <div>
        <div class="dropdown-container">
          <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="대전">
     ...
     <div class="content">
      <div class="container">
         <div class="category-menu">
          ...
          <div class="large-category-item" v-for="category in daejeon" :key="category.largeCode">
        ...
        <div class="region-container">
          <div class="image">
            <img src="../../assets/daejeon.jpg" alt="daejeon"  height="350">
          </div>
            <div class="location-description">
              ...
              <p>대전시는 대한민국 중부에 위치한 도시로, 충청남도와 충청북도 사이에 있습니다. 대전시는 한국의 중심지로서 교통과 기술의 중심지이며, 대한민국의 중앙정부 기관이 위치하는 지역입니다.
                    대전시에는 한국과학기술원(KAIST), 한국전력공사(KEPS), 한국전자통신연구원(KETI) 등의 국가 연구기관과 대학교 등이 위치해 있습니다. 이러한 인프라 및 기관들은 대전시를 과학기술 및 연구개발 분야에서 세계적인 대학교육과 학술 연구 중심지로 만들어주고 있습니다.
              </p>
            </div>
        </div>
     </div>
...
<script>
import daejeon from './data/daejeon.js';
